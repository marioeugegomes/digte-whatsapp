...
import com.br.unimedflorianopolis.arquitetura.exception.BadGatewayException;
import com.br.unimedflorianopolis.arquitetura.exception.BadRequestException;
import com.br.unimedflorianopolis.arquitetura.exception.DataBaseErrorException;
import com.br.unimedflorianopolis.arquitetura.exception.DataIntegrityViolationException;
import com.br.unimedflorianopolis.arquitetura.exception.DateNotFoundException;
import com.br.unimedflorianopolis.arquitetura.exception.DocumentNotFoundException;
import com.br.unimedflorianopolis.arquitetura.exception.DownloadException;
import com.br.unimedflorianopolis.arquitetura.exception.DownloadFileException;
import com.br.unimedflorianopolis.arquitetura.exception.DownloadServiceNotFoundException;
import com.br.unimedflorianopolis.arquitetura.exception.GatewayTimeoutException;
import com.br.unimedflorianopolis.arquitetura.exception.InternalServerErrorException;
import com.br.unimedflorianopolis.arquitetura.exception.InvalidExtensionException;
import com.br.unimedflorianopolis.arquitetura.exception.KafkaTimedOutException;
import com.br.unimedflorianopolis.arquitetura.exception.ReadExcelSupportFundException;
import com.br.unimedflorianopolis.arquitetura.exception.ServiceUnavailableException;
import com.br.unimedflorianopolis.arquitetura.exception.UnauthorizedException;
import com.br.unimedflorianopolis.arquitetura.exception.UnexpectedErrorException;
import com.br.unimedflorianopolis.arquitetura.exception.UnimedCoreNotFoundException;
import com.br.unimedflorianopolis.arquitetura.exception.UploadException;
